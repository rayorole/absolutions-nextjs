          ...
          <div className="my-3 space-y-2">
            ...
            >
              ...
              <div
                className={
                  NBopen
                    ? 'mt-3 max-w-2xl text-sm text-gray-500 text-left'
                    : 'hidden'
                }
              >
                <p>
            ...
            >
              ...
              >
                <p>
                  ...
                  verdient en garanderen. Wij doen ook folie-werken,
                  verschillende zwembadtechnieken, Roldeck®, andere afdekkingen
                  of nieuw leidingwerk.
                </p>
                <button
                  onClick={Redirect}
                  className="py-2 px-4 mt-3 bg-cyan-700 rounded-md flex items-center text-white text-xs font-semibold"
            ...
            >
              ...
              >
                <p>
                  Heeft uw zwembad een technisch probleem, is er een lamp stuk
                  of doet de pomp het niet meer? Wij lossen dit voor u op. Is
                  een herstelling van het originele stuk niet mogelijk? Dan
                  bespreken we met u de mogelijkheden.
                </p>
                <button
                  onClick={Redirect}
                  className="py-2 px-4 mt-3 bg-cyan-700 rounded-md flex items-center text-white text-xs font-semibold"
            ...
            >
              ...
              >
                <p>
                  Wekelijks vraagt uw zwembad om een onderhoud. Een proper
                  zwembad is van groot belang vergroot de levensduur van het
                  zwembad en de kwaliteit van de installatie. Hierdoor houden we
                  de waterkwaliteit in perfecte staat zodat u zorgeloos kan
                  genieten van het zwemmen.
                </p>
                <button
                  onClick={Redirect}
                  className="py-2 px-4 mt-3 bg-cyan-700 rounded-md flex items-center text-white text-xs font-semibold"
